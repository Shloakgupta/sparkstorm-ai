...
const knowledgeBase = {
  ...
  "sparkstorm": "Sparkstorm AI is an innovative AI-powered platform that helps businesses streamline their operations and enhance productivity through cutting-edge technology solutions. We specialize in providing intelligent automation, data analytics, and AI-driven insights to help businesses make better decisions and improve efficiency.",
  ...
  "who is the ceo": "Noopur Gupta is the CEO of Sparkstorm AI, bringing extensive experience in technology and business leadership. Under her guidance, Sparkstorm AI has grown into a leading provider of AI solutions, helping businesses transform their operations through innovative technology.",
